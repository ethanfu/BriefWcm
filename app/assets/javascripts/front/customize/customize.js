...
(function($) {
    ...
    DM3_C.init = function() {
        ...
        css.attr('href', '/assets/front/customize/customize.css');
        $('head').append(css);
        $.getScript('/assets/front/customize/website.js');
    ...
    DM3_C.init_colorpicker = function(callback) {
        ...
        $.getScript('/assets/front/customize/colorpicker.js', function(data, textStatus, jqxhr) {
           callback.apply();
        });
        
        css.attr('href', '/assets/front/customize/css/colorpicker.css');
        $('head').append(css);
    };
